...
function show_topics(answer)
{
    ...
    $("#category_menu_inside").ready(
    function()
    {
        $('<div class="topic_label"><div class="topic" style="cursor:default" id="topic_label1"></div> <div class="topic" style="color:red; cursor:default">'+
            $("#cat_"+$("#act_category").html()).html()+
